...
function NavigationMenu({
  ...
  return <NavigationMenuPrimitive.Root
    ...
    {...props}
  >{children}{viewport && <NavigationMenuViewport />}</NavigationMenuPrimitive.Root>;
}
...
function NavigationMenuIndicator({
  ...
  return <NavigationMenuPrimitive.Indicator
    ...
    {...props}
  ><div className="bg-border relative top-[60%] h-2 w-2 rotate-45 rounded-tl-sm shadow-md" /></NavigationMenuPrimitive.Indicator>;
}
export {
  NavigationMenu,
